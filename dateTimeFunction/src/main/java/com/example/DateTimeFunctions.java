...
public class DateTimeFunctions {
	...
	public static String getTimeDifference(LocalDate date1, LocalDate date2) {
		//YOUR CODE STARTS HERE
        // Get period difference between the two dates
        Period differencePeriod = date1.until(date2);

        // Format date into a string
        return String.format("Years-%d:Months-%d:Days-%d",
                                                    differencePeriod.getYears(),
                                                    differencePeriod.getMonths(),
                                                    differencePeriod.getDays());
		//YOUR CODE ENDS HERE
